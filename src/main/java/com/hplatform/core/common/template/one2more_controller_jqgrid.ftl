...
public class ${table.domainName}Controller extends BaseController {
    ...
    @ResponseBody
    public Page<${table.domainName}> list${table.domainName}Data(${table.domainName} ${table.domainName?uncap_first}) throws CRUDException {
    	Page.setPageFromRequest();
    	Page<${table.domainName}> pageInfo = new Page<${table.domainName}>(${table.domainName?uncap_first}Service.findAll(${table.domainName?uncap_first}));
        return pageInfo;
    }
