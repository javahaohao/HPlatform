...
<html>
<head>
    <tags:header inplugins="${plugins.jqgrid},${plugins.jqui},${plugins.template},${plugins.jbox}" title="父表"></tags:header>
</head>
<body>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#grid-table').jqDatagrid({
				...
				columnModel:[
		        	{header:'班级名字',name:'className',index:'cls.class_name',sortable:false},
		        	{header:'楼层',name:'floor',index:'cls.floor',sortable:true},
		        	{header:'创建人',name:'createUserName',index:'cls.create_user',sortable:true},
		        	{header:'修改人',name:'updateUserName',index:'cls.update_user',sortable:true},
		        	{header:'创建时间',name:'createDate',index:'cls.create_date',sortable:true,formatter:function(val,options,obj,oper){
                        return new Date(val).format('yyyy-MM-dd hh:mm:ss');
                    }},
		        	{header:'修改时间',name:'updateDate',index:'cls.update_date',sortable:true,formatter:function(val,options,obj,oper){
                        return new Date(val).format('yyyy-MM-dd hh:mm:ss');
                    }},
