...
<html>
<head>
    <tags:header inplugins="${plugins.jqgrid},${plugins.jqui},${plugins.template}" title="子表"></tags:header>
</head>
<body>
		...
		$(function(){
			...
			$('#grid-table').jqDatagrid({
				...
				columnModel:[
		        	...
		        	{header:'创建人',name:'classInfo.createUser',index:'create_user',sortable:true},
		        	{header:'修改人',name:'classInfo.updateUser',index:'update_user',sortable:true},
		        	{header:'创建时间',name:'classInfo.createDate',index:'create_date',sortable:true,formatter:function(val,options,obj,oper){
                        return new Date(val).format('yyyy-MM-dd hh:mm:ss');
                    }},
		        	{header:'修改时间',name:'classInfo.updateDate',index:'update_date',sortable:true,formatter:function(val,options,obj,oper){
                        return new Date(val).format('yyyy-MM-dd hh:mm:ss');
                    }},
